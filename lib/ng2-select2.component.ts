...
import {
    ...
    Output, SimpleChanges, ViewChild, ViewEncapsulation, Renderer2 as Renderer, OnInit,
} from '@angular/core';

import { Select2OptionData, Select2Options } from './ng2-select2.interface';
...
export class Select2Component implements AfterViewInit, OnChanges, OnDestroy, OnInit {
    ...
    private element: JQuery & { select2?: any } = undefined;
